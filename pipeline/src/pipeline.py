...
def PreprocessOp(name, input_dir, output_dir):
    return dsl.ContainerOp(
        name=name,
        image='registry.cn-hangzhou.aliyuncs.com/kubeflow-ai/nvidia-resnet-components-preprocess',
        arguments=[
            '--input_dir', input_dir,
...
def InferenceServerLauncherOp(name, input_dir, trtserver_name):
    return dsl.ContainerOp(
        name=name,
        image='registry.cn-hangzhou.aliyuncs.com/kubeflow-ai/nvidia-resnet-inference_server_launcher',
        arguments=[
...
def WebappLauncherOp(name, trtserver_name, model_name, model_version, webapp_prefix, webapp_port):
    return dsl.ContainerOp(
        name=name,
        image='registry.cn-hangzhou.aliyuncs.com/kubeflow-ai/nvidia-resnet-components-webapp_launcher',
        arguments=[
